...
class PolynomialTestCase(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.Penalty = {'0':100,'1':50,'c':50,'w':20,'s':20}
        cls.Points = {x:4 for x in "bcdefghijklmnostuvw"}
        cls.Points['w'] = 0
        cls.Points['s'] = 0
        cls.Points['j'] = 6
        cls.Points['o'] = 10
...
testcases={
'modeling.py':PolynomialTestCase,
}

if __name__ == '__main__':
    print('Modeling (HW5) Checker Version {0}.{1}\n'.format(*VERSION))
    g={}
